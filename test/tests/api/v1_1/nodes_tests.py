...
class NodesTests(object):
    ...
    @test(groups=['node_workflows_finish'], depends_on_groups=["test_node_workflows_post_reboot"])
    ...
    @test(groups=['delete_all_node'],
            depends_on_groups=["node_workflows_finish", "test-bm-discovery-prepare"])
