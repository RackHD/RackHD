...
specified via nodeid. Immediate rediscovery when run will do a reboot of the
node automatically. The test will check to see the catalogs get refreshed
...
class api20_node_rediscovery(unittest.TestCase):
    ...
    def test04_verify_rediscovery(self):
        ...
        self.assertNotEqual(new_ipmi_user, self.__previous_ipmi_user, msg="IPMI user didn't change after rediscover")
