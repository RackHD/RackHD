...
Description: Defines a RackHD Administrator user role class and methods. An instance of this class allows
             for Administrator account permission between the Administrator user and the RackHD server APIs.
'''
